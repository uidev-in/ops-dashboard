...
// -----------------------custom code by sourabh
                        ...
                        console.log('new2',date2)
                        getDaysArray(date,date2);

                          function getDaysArray(timestamp,timestamp2) {for(var a=[],d=new Date(timestamp);d<=timestamp2;d.setDate(d.getDate()+1)){ a.push(new Date(d));}return console.log('data6',a);};
